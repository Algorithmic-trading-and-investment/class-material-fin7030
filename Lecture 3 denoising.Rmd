...
output:
  xaringan::moon_reader:
    ...
    # yolo:
    #   times: 3
    #   img: 'https://raw.githubusercontent.com/barryquinn1/quinnference_website/master/content/authors/admin/avatar3.gif' 
---
...
```{r squareunit3, echo=FALSE, fig.cap="Figure 3",out.width="30%",fig.align='right'}
